...
tit <- tit[c(1,2,3,6,7,9,10,11,12,13,14,15,17,18,20,21,22,23,24,25)]
...
pr <- pr[c(1,2,3,6,7,9,10,11,12,13,14,15,17,18,20,21,22,23,24,25)]
...
tit1 <- tit1[c(1,2,3,6,7,10,11,12,13,14,15,18,21,22,23,24,25,27,28,29)]
...
pr1 <- pr1[c(1,2,3,6,7,10,11,12,13,14,15,18,21,22,23,24,25,27,28,29)]
...
#comparacion Vebonos
v <- Tabla.splines(data = data_completa,tipo = "VEBONO",fe=as.Date("2018-03-08"),num = 40,par = 0.4,tit1,C,pr=pr1)
